...
public class Helper {
    ...
    public static int timeOutInMillis = 100;
    ...
    public static MobileElement fetchElement(AppiumDriver<MobileElement> driver, String object) throws Exception {
        try {
            WebDriverWait wait = new WebDriverWait(driver, timeOut, timeOutInMillis);
     ...
     * @throws Exception
     */
    public static void assertElementExists(AppiumDriver<MobileElement> driver, String locator, String failMsg) throws Exception {
        boolean elementExists = doesElementExist(driver, locator);
        if (elementExists) {
     ...
     */
    public static boolean doesElementExist(AppiumDriver<MobileElement> driver, String selector) {
        try {
            WebDriverWait wait = new WebDriverWait(driver, timeOut, timeOutInMillis);
            wait.ignoring(org.openqa.selenium.NoSuchElementException.class);
            By locator;
